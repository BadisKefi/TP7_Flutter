...
Future getAllStudent() async {
  Response response =
      await http.get(Uri.parse("http://192.168.97.215:8080/etudiant/all"));
  return jsonDecode(response.body);
}

Future deleteStudent(int id) {
  return http
      .delete(Uri.parse("http://192.168.97.215:8080/etudiant/delete?id=$id"));
}

Future addStudent(Student student) async {
  print(student.dateNais);
  Response response =
      await http.post(Uri.parse("http://192.168.97.215:8080/etudiant/add"),
...
Future updateStudent(Student student) async {
  Response response =
      await http.put(Uri.parse("http://192.168.97.215:8080/etudiant/update"),
          headers: {"Content-type": "Application/json"},
